...
export default async function CatchAllPage({ params }: { params: Promise<{ locale: string; slug: string[] }> }) {
  ...
  if (isContentType(first)) {
    ...
    const GUIDE_STOP_WORDS = new Set(['crunch', 'butter', 'roller', 'cash', 'flavors', 'flavor', 'expansion', 'upgrades', 'upgrade', 'farming', 'asmr', 'ex10', 'roblox', 'codes', 'code', 'guide', 'guides', 'tier', 'list', 'update', 'updates', 'the', 'a', 'an', 'and', 'or', 'in', 'on', 'at', 'to', 'for', 'is', 'it', 'how', 'what', 'all', 'vs', 'game', 'wiki', 'best']);
